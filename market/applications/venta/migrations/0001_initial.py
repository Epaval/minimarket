    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "count",
                    models.PositiveIntegerField(verbose_name="Cantidad de Productos"),
                ),
                (
                    "amount",
                    models.DecimalField(
                ...
                (
                    "close",
                    models.BooleanField(default=False, verbose_name="Venta cerrada"),
                ),
                (
                    "anulate",
                    models.BooleanField(default=False, verbose_name="Venta Anulada"),
                ),
                (
                    "user",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "price_purchase",
                    models.DecimalField(
                        decimal_places=3, max_digits=10, verbose_name="Precio Compra"
                    ),
                ),
                (
                    "price_sale",
                    models.DecimalField(
                        decimal_places=2, max_digits=10, verbose_name="Precio Venta"
                    ),
                ),
                (
                    "tax",
                    models.DecimalField(
                        decimal_places=2, max_digits=5, verbose_name="Impuesto"
                    ),
                ),
